...
| Nuxt Version | @vitejs/plugin-legacy | minify        | Chrome 49 | Chrome 61 | Chrome 91 |
| ------------ | --------------------- | ------------- | --------- | --------- | --------- |
| 4.5.x        | 8.x                   | terser        | ✅ PASS   | ✅ PASS   | ✅ PASS¹  |
| 4.5.x        | 8.x                   | oxc (default) | ⚠️ ²      | ⚠️ ²      | ✅ PASS¹  |
...
² plugin-legacy 8.1+ with oxc minify re-introduces ES2020-era syntax (`?.`, `??`) in legacy chunks; Chrome <80 can't parse the output. The module emits a build-time warning recommending `vite.build.minify: 'terser'`.
