// Vendored from @vitejs/plugin-legacy v7 — DO NOT ALTER THIS CONTENT.
// Source: https://github.com/vitejs/vite/blob/v7.0.0/packages/plugin-legacy/src/snippets.ts
// https://gist.github.com/samthor/64b114e4a4f539915a95b91ffd340acc

/** @vitejs/plugin-legacy v7: `safari10NoModuleFix` */
...
/** @vitejs/plugin-legacy v7: `legacyPolyfillId` */
export const legacyPolyfillId = 'vite-legacy-polyfill'

/** @vitejs/plugin-legacy v7: `legacyEntryId` */
export const legacyEntryId = 'vite-legacy-entry'

/** @vitejs/plugin-legacy v7: `systemJSInlineCode` */
...
/** @vitejs/plugin-legacy v7: `modernChunkLegacyGuard` */
